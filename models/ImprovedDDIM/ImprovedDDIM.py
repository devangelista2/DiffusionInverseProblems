...
class ImprovedDDIM(object):
    def __init__(self, config):
        ...
        # Define the model
        self.model = create_model(image_size=256,     
                        ...
                        use_fp16=False,
                        use_new_attention_order=False).to(self.device)
    ...
    def train(self, dataset):
        ...
        for epoch in range(self.config.training.n_epochs):
            ...
            for i, x_0 in enumerate(loop):   
                ...
                # Recover e from x_t
                eps_pred = self.model(x_t, alpha_t[:, 0, 0, 0])
            ...
            if (epoch % 10) == 0:
                weights_path = f"./model_weights/ImprovedDDIM/{self.config.data.dataset}_{self.config.training.loss}.pth"
