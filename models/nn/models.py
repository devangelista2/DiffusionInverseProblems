...
##############################################
# CLASSICAL UNET FOR GAN
class UNet(nn.Module):
    """
    Implements a UNet model
    """
    ...
    def forward(self, z):
        # Preprocess z to have the right number of channels
        h = self.preprocess_conv(z)
...
##############################################
# CONDITIONED UNET MODELS FOR DIFFUSION
...
class ConditionedAttnUNet(nn.Module):
    """
